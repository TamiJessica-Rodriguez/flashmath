                            ...
                            <React.Fragment key={idx}>
                                <div
                                    className={`${note.colorClass} ${
                                        dayNotes.length === 4 ? 'h-28' : 'h-32'
                                    } w-full rounded-lg shadow-lg relative flex flex-col justify-center items-center text-center`}
                                >
                                ...
                                {idx < dayNotes.length - 1 && (
                                    <div
                                        ...
                                        )} w-full bg-gray-200 rounded-lg shadow-inner flex items-center justify-start pl-2 mt-1`}
                                    >
