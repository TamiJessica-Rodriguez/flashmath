                            ...
                            {project.tasks.map((task: Task) => (
                                <a
                                    ...
                                    className={`block p-3 rounded-lg ${
                                        ['Dokumentärer', 'Filmer', 'Föreläsningar'].includes(project.title) ? 'bg-white shadow-md flex items-center gap-4' : 'bg-gray-100'
                                    }`}
                                >
                                    {/* Visa bilder för "Dokumentärer", "Filmer", och "Föreläsningar" */}
                                    {['Dokumentärer', 'Filmer', 'Föreläsningar'].includes(project.title) && task.imageId && (
