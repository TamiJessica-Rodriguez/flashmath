...
//     // Förinställda frågor om studieteknik
...
//                             <button key={index} onClick={() => setQuery(question)} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg shadow-md">
//                                 {question}
//                             </button>
//                         ))}
//                     </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-200 to-gray-400 text-gray-800 flex flex-col items-center justify-center px-6">
            <div className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg">
                ...
                <button onClick={onClose} className="bg-yellow-600 hover:bg-yellow-700 text-white w-full py-2 rounded-lg text-center font-bold mt-6">
                    ↩ Tillbaka till uppgiften
                </button>
            </div>
        </div>
