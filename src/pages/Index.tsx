...
//     // Skapa en state för att lagra temat (sommar/vinter)
...
//                 style={{
//                     backgroundImage: `url('./assets/images/${theme === 'summer' ? 'startPage.webp' : 'winter.webp'}')`,
//                 }}
//             >
//                 {/* Växla tema-knapp */}
//                 <button onClick={toggleTheme} className="absolute top-4 right-4 text-white text-3xl">
//                     🌞 / ❄️
//                 </button>
