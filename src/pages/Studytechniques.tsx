        ...
        <div className="min-h-screen bg-gray-100 text-gray-800 p-6">
            ...
            {showAssistant && (
                <div ref={assistantRef} className="mt-10 max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="mb-6">
                        <label htmlFor="question-input" className="block text-lg font-medium text-gray-700 mb-2">
                        ...
                        <input
                            ...
                            className="w-full p-3 rounded-lg border border-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100 text-gray-800"
                            value=""
                        />
                    </div>
