...
//     useEffect(() => {
//         // Lyssna på scrollning
//         window.addEventListener('scroll', onScrollHandler);

//         // Visa/hide loader animation
//         const screenLoader = document.getElementsByClassName('screen_loader');
//         if (screenLoader?.length) {
//             screenLoader[0].classList.add('animate__fadeOut');
//             setTimeout(() => {
...
//             {/* Go-to-top-knapp */}
//             {showTopButton && (
//                 <button type="button" className="fixed bottom-6 right-6 z-50 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-3 shadow-lg" onClick={goToTop}>
//                     ⬆️
//                 </button>
//             )}
